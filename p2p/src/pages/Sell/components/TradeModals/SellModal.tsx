...
const SellModal = ({ orderInfo, isOpen, onClose }: ILockToken) => {
  ...
  useMemo(() => {
    if (amountToPay) {
      if (orderInfo?.asset === "RGP") {
        ...
        } else if ((parseFloat(amountToPay) > orderInfo?.crypto_amount)&& !isDemoAccount) {
          dispatch(
            addToast({
      ...
      } else if ((parseFloat(fee) > parseFloat(rgpBalance))&& !isDemoAccount) {
        dispatch(
          addToast({
            message:
      ...
      } else if ((parseFloat(amountToPay) > parseFloat(balance))&& !isDemoAccount) {
        dispatch(
          addToast({
