...
const FileViewer = ({uri, name, extension,removeImage}: ImageRef) => {
  return (
    <Box
      width="100px"
    my={3} 
        ...
        <Flex justifyContent="space-between" alignItems={"center"}>
          <HStack>
            ...
            {/* <Text fontSize="12px">{shortenInfo(name,2)}.{extension}</Text> */}
            <Text fontSize="12px"  
    onClick={()=>window.open(uri)}
    cursor="pointer">image</Text>
            <Circle size="23px">
               <CloseIcon w= "10px" h="10px" color="gray.500" onClick={()=>removeImage(name)}/>
            </Circle>
           
          </HStack>
          {/* <Link href={uri} isExternal  color={'#319EF6'}>View</Link> */}
        </Flex>
      </Box>
  )
}
