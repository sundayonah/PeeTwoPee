import { useState, useMemo, useEffect, memo, useCallback,Dispatch,SetStateAction } from "react"
import {
  useColorModeValue,
  Box,
  Flex,
...
import { uriToHttp } from "../../utils/functions/convert";
...
import { parseENSAddress } from "../../utils/functions/ens";
          ...
          <Box mt="3">
            ...
            <Flex>
              ...
              <Box className="tooltip">
                <SettingsIcon ml="2" mt="-2"  onClick={()=>setShowData(!showData)} />
               {showData && <Box fontSize="16px"background={boxColor2} position="absolute">
        ...
        {tempList && (
          <Flex justifyContent="space-between">
            <Flex>
              ...
              <Box ml="4">
                <Text fontWeight="bold">{tempList.name}</Text>
