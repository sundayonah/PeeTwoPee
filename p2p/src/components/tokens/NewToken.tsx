...
import Warning from '../../assets/logo/logo.svg'; 
import LightWarning from '../../assets/logo/logo.svg'; 
...
tokens?:Token[],
open:boolean,
setDisplayImportedToken:Dispatch<SetStateAction<boolean>>,
handleCurrencySelect?: (currency: Token) => void
}

const NewToken:FC<IModal> = ({
  tokens,
  open,
