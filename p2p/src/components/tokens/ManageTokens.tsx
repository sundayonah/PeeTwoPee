import{ useState, Dispatch, useMemo,FC,SetStateAction } from 'react';
import {
  Box,
  Flex,
  Text,
...
import { useToken } from '../../utils/hooks/Tokens';
...
type IModal = {
  setOpenNewTokenModal: Dispatch<SetStateAction<boolean>>
  openNewTokenModal: boolean
  handleCurrencySelect?: (currency: Token) => void
};

const ManageToken: FC<IModal> = ({
