...
export const RigelDecentralizedP2PSystem: { [key: string]: string } = {
  "1": "0x",
  "3": "0x",
  "56": "0x",
  "97": "0x7A79a1Fff9441Fe7cA1107c8E1B10baa3e7940F0",
  "137": "0x",
  "80001": "0x5c7C6728fd3430cd40109Fd1d7d509BACF355dc8",
  "42261": "0x",
  "42262": "0x",
};
export const SMARTSWAP_NFT: { [key: string]: string } = {
  "97": "0x40a480f760C964e06165aB4dE9fD05d62264E000",
};

export const LAUNCHPAD_NFT: { [key: string]: string } = {
  "97": "0x77e2cD48240de25Fc05EB2B6722801FaF9FAc87b",
};

export const GIFTDAPP_NFT: { [key: string]: string } = {
  "97": "0x8c301cC18702E52DC866516DD3Ef492975B0b41a",
};

export const RIGEL_REWARD_POOL: { [key: string]: string } = {
  "97": "0x745f8e904b9aa72aa21a6fcb7952fb7fe7243223",
};

export const PRGP: { [key: string]: string } = {
  "97": "0xa1Cf53F7BD910Be1CE5C34fb15228018b75253bd",
  "56": "0x29A80E16C08b8FF4FaC4df95Ff638907490DCF10",
  "137": "0xf78234E21f1F34c4D8f65faF1BC82bfc0fa24920",
};
...
export const TOKEN_ADDRESSES: { [key: string]: { [key: string]: string } } = {
  ...
  BNB: {
    ...
    "56": "0x23967E68bB6FeA03fcc3676F8E55272106F44A4A",
  },
};
...
export const CONTRACT_ADDRESSES: { [key: string]: { [key: string]: string } } =
  {
    "97": {
      P2P: "0xc71FBC5fb0f9f41a59b92C4ca2ddB44cBaE4bcCB",
      STAKING: "0x4c253cde17885fea613b38a206ca18d41686cc14",
      REWARD: "0x871255B4390E9A5BE6E9FcF1c6375f01efDd25B8",
    },
    "80001": {
      P2P: "0x045807B6c56C895ED566F5B5ABD811cD53053c6f",
      STAKING: "0x3548Ce7fcB383bdEfA13A0894d914c5427d1B513",
    },
    "56": {
      P2P: "0x1Df2ba250b19F03458d3291b006B73c246658E37",
      STAKING: "0x751dfb1a0b767539617933d2ec5d6ab3a67abf20",
      REWARD: "0xF4029Ef6F77415CfDA92564fF72f7C11aeBA7f00",
    },
    "137": {
      P2P: "0x3822663f583cb3eD36E296afc80A35933754B66a",
      STAKING: "0xc004359418800b07bf1a214188223b89cbef4d7d",
      REWARD: "0xC10C46c3E70554a4a2F6bebD29991c14709aBd79",
    },
  };
